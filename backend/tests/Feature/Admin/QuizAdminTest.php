...
class QuizAdminTest extends TestCase
{
    ...
    {
        $response = $this->actingAs($this->admin, 'admin')->postJson('/api/admin/v1/quizzes', [
    ...
    public function test_admin_can_add_questions_and_publish()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')->postJson("/api/admin/v1/quizzes/{$quiz->id}/questions", [
        ...
        $publishResponse = $this->actingAs($this->admin, 'admin')->postJson("/api/admin/v1/quizzes/{$quiz->id}/publish");
