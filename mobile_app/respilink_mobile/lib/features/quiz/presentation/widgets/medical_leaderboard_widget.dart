        ...
        children: [
          if (second != null) ...[
            PodiumItemWidget(
              ...
              imageUrl: second.avatarUrl ?? "${AppConstants.imagePath}doctor.jpg",
              podiumHeight: 100,
          ...
          if (first != null)
            PodiumItemWidget(
              ...
              name: first.name,
              points: '${first.points}',
              imageUrl: first.avatarUrl ?? "${AppConstants.imagePath}doctor.jpg",
              podiumHeight: 120,
          ...
          if (third != null) ...[
            ...
            PodiumItemWidget(
              ...
              name: third.name,
              points: '${third.points}',
              imageUrl: third.avatarUrl ?? "${AppConstants.imagePath}doctor.jpg",
              podiumHeight: 80,
