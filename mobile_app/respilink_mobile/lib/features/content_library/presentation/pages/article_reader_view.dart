    ...
    return BlocBuilder<ThemeCubit, ThemeMode>(
      builder: (context, themeMode) {
        return Scaffold(
          ...
          appBar: RespiLinkAppBar(showSearchAction: false),
                ...
                BlocConsumer<ContentDetailsBloc, ContentDetailsState>(
                  ...
                  builder: (context, state) {
                    ...
                    final relatedArticles = [
                      for (final related
                          in details.relatedContent ?? const <RelatedContent>[])
                        _mapRelated(related),
                    ];
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ArticleTagRow(
                            tag: (details.topic ?? details.type ?? '')
                                .toUpperCase(),
                          ...
                          ArticleEngagementBar(
                            ...
                            onLikeTap: () => context
                                .read<ContentDetailsBloc>()
                                .add(ContentLikeToggled()),
                            onCommentTap: () {
                              // TODO: navigate to comments once they exist.
                            },
                            onSaveTap: () => context
                                .read<ContentDetailsBloc>()
                                .add(ContentBookmarkToggled()),
                          ),
